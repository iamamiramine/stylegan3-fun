...
from src.infrastructure.torch_utils import misc, gen_utils, training_stats
from src.infrastructure.torch_utils.ops import conv2d_gradfix, grid_sample_gradfix
...
def training_loop(
    ...
    if (resume_pkl is not None) and (rank == 0):
        ...
        with dnnlib.util.open_url(resume_pkl) as f:
            resume_data = legacy_service.load_network_pkl(f)
