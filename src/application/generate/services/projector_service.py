...
from src.infrastructure.dnnlib.util import format_time
import legacy

from src.infrastructure.torch_utils import gen_utils
from tqdm import tqdm
from src.infrastructure.pytorch_ssim import SSIM  # from https://github.com/Po-Hsun-Su/pytorch-ssim

from application.network.models.network_features_model import VGG16FeaturesNVIDIA, DiscriminatorFeatures

from application.metrics.models import metric_utils
...
def run_projection(
    ...
    \b
    python projector_service.py --target=~/mytarget.png --project-in-wplus --save-video --num-steps=5000 \\
