...
import torch
import dnnlib
from infrastructure.torch_utils import misc
...
def convert_tf_generator(tf_G):
    ...
    # Convert kwargs.
    from application.training.models import networks_stylegan2
...
def convert_network_pickle(source, dest, force_fp16):
    ...
    with infrastructure.dnnlib.util.open_url(source) as f:
