...
from infrastructure.dnnlib.util import format_time
import legacy

from infrastructure.torch_utils import gen_utils
from tqdm import tqdm
from infrastructure.pytorch_ssim import SSIM  # from https://github.com/Po-Hsun-Su/pytorch-ssim

from network_features import VGG16FeaturesNVIDIA, DiscriminatorFeatures

from src.domain.metrics import metric_utils
...
def run_projection(
    ...
    with infrastructure.dnnlib.util.open_url(network_pkl) as fp:
